import {Box, Grid, Typography, Table, TableContainer, TableBody, TableHead, TableRow, TableCell, Paper} from '@mui/material';
...
export const Info = () => {
  ...
  const result = {
    ...
    data: [
      {date: new Date(2023, 4, 1), nav: 10.420},
  ...
  return <Box>
    ...
    <TableContainer component={Paper}>
      <Table>
        ...
        <TableBody>
          {result.data.map((datum, idx) => <TableRow key={idx}>
